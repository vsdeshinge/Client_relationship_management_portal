...
// customer data form
    ...
    function submitServiceProviderForm(event) {
        ...
        fetch(`/api/service-providers/${leadId}`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
    ...
    function validateManufacturerData() {
      ...
      function submitManufacturerForm(event) {
        ...
        fetch(`/api/manufacturers/${leadId}`, {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
          ...
          .then((data) => {
            ...
            if (fileInput && fileInput.files.length > 0) {
              ...
              fetch(`/api/manufacturers/${leadId}/file`, {
                method: 'PATCH',
                headers: {
                  Authorization: `Bearer ${token}`,
                },
    ...
    function submitMarketAccessForm(event) {
        ...
        fetch(`/api/channel-partners/${leadId}`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
    ...
    function submitDomainExpertForm(event) {
        ...
        fetch(`/api/domain-experts/${leadId}`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
